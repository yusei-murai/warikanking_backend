...
class Adjustment(models.Model):
    ...
    adjust_user = models.ForeignKey("User",on_delete=models.CASCADE,default=1,related_name='pay_user',null=False)
    adjusted_user = models.ForeignKey("User",on_delete=models.CASCADE,default=1,related_name='paid_user',null=False)
...
class Friend(models.Model):
    id = models.UUIDField(primary_key=True,default=uuid.uuid4,editable=False)
    request_user = models.ForeignKey("User",on_delete=models.CASCADE,default=1,related_name='request_user',null=False)
    requested_user = models.ForeignKey("User",on_delete=models.CASCADE,default=1,related_name='requested_user',null=False)
